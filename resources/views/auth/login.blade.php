...
<head>
    ...
    <link href="{{asset('sb/fonts/fontawesome-free/css/all.min.css')}}" rel="stylesheet" type="text/css">
                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="form-group">
                                            <input type="email" name="email" class="form-control form-control-user @error('email') is-invalid @enderror" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Masukkan Alamat Email...">
                                            @error('email')
                                    ...
                                    <div class="text-center">
                                        ...
                                        <a class="small text-dark" href="forgot-{{route('password.request')}}">Lupa Password?</a>
                                        @endif
                                    </div>
                                    <div class="text-center">
                                        <a class="small text-dark" href="{{url('/register')}}">Buat Akun!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
